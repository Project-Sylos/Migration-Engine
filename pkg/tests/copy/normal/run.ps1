...
Write-Host "=== Copy Phase Test Runner ===" -ForegroundColor Cyan
Write-Host ""
...
if (-not (Test-Path $sourceDB)) {
    ...
    Write-Host "Please provide a pre-provisioned test database with traversal complete." -ForegroundColor Yellow
    exit 1
}
...
Write-Host "Running copy phase test..." -ForegroundColor Cyan
