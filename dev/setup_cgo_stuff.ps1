...
# This is primarily used and needed for the DuckDB 
# compatibility requirements. This is only needed 
# for developers and not required for the production 
# binary build.
# This script sets up MSYS2, GCC, and environment variables
